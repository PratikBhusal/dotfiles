# Generated by Powerlevel10k configuration wizard on 2023-08-29 at 10:41 CDT.
...
() {
  ...
  # Prompt symbol in visual vi mode. In pure, this symbol was ❰
  # In pure prompt, this symbol was ❰
  ...
  #
  # Note: setting this to () hides the icon. Unsure what else this does.
  typeset -g POWERLEVEL9K_DIR_CLASSES=()
  ...
  function my_git_formatter() {
    emulate -L zsh
    local green_number=2
    local yellow_number=11
    local blue_number=12
    local red_number=9
    local grey_number=8
    ...
    if (( $1 )); then
      ...
      local      clean="%${green_number}F"  # green foreground
      local   modified="%${yellow_number}F" # yellow foreground
      local  untracked="%${blue_number}F"   # blue foreground
      local conflicted="%${red_number}F"    # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta="%${gray_number}F"  # grey foreground
      local      clean="%${gray_number}F"  # grey foreground
      local   modified="%${gray_number}F"  # grey foreground
      local  untracked="%${gray_number}F"  # grey foreground
      local conflicted="%${gray_number}F"  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$light_grey
